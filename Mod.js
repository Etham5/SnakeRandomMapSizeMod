snake.size = function(settings = {}) {
  ...
  for(let script of scripts) {
    ...
    req.onload = function() {
      ...
      icon.src = 'https://cdn.classlink.com/beta/framework/scripts/holiday-theme-dev/fall-ani/src/assets/scarec_head.svg';
      icon.width = 47;
      icon.height = 47;
...
snake.size({
  width:        Math.floor(Math.random() * (40 - 5 + 1)) + 5,   // width of the board
  height:       Math.floor(Math.random() * (24 - 3 + 1)) + 3,   // height of the board
  dark:         false,   // true/false, whether you want dark mode enabled
});
